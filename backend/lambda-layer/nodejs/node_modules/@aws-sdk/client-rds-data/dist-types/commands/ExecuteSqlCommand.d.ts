...
declare const ExecuteSqlCommand_base: {
    new (input: ExecuteSqlCommandInput): import("@smithy/core/client").CommandImpl<ExecuteSqlCommandInput, ExecuteSqlCommandOutput, import("..").RDSDataClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ExecuteSqlCommandInput): import("@smithy/core/client").CommandImpl<ExecuteSqlCommandInput, ExecuteSqlCommandOutput, import("..").RDSDataClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
