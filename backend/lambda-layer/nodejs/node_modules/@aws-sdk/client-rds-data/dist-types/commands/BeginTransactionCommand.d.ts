...
declare const BeginTransactionCommand_base: {
    new (input: BeginTransactionCommandInput): import("@smithy/core/client").CommandImpl<BeginTransactionCommandInput, BeginTransactionCommandOutput, import("..").RDSDataClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: BeginTransactionCommandInput): import("@smithy/core/client").CommandImpl<BeginTransactionCommandInput, BeginTransactionCommandOutput, import("..").RDSDataClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
