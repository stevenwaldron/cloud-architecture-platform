...
declare const CommitTransactionCommand_base: {
    new (input: CommitTransactionCommandInput): import("@smithy/core/client").CommandImpl<CommitTransactionCommandInput, CommitTransactionCommandOutput, import("..").RDSDataClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CommitTransactionCommandInput): import("@smithy/core/client").CommandImpl<CommitTransactionCommandInput, CommitTransactionCommandOutput, import("..").RDSDataClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
