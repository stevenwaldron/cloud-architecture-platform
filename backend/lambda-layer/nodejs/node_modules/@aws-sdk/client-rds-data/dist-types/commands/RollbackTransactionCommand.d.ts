...
declare const RollbackTransactionCommand_base: {
    new (input: RollbackTransactionCommandInput): import("@smithy/core/client").CommandImpl<RollbackTransactionCommandInput, RollbackTransactionCommandOutput, import("..").RDSDataClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: RollbackTransactionCommandInput): import("@smithy/core/client").CommandImpl<RollbackTransactionCommandInput, RollbackTransactionCommandOutput, import("..").RDSDataClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
